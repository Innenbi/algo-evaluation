 ...
 */
function alternate(tableau1, tableau2) {
    var newTable = [];
...
console.log(alternate(tableau1Combine, tableau2Combine));
/**
...
console.log(rota(tableauRotate, 2));
